...
import { IWorkspaceSidebarNavigationItem, IWorkspaceSidebarNavigation } from "src/types";
...
export class WorkspaceService extends APIService {
  ...
  async fetchWorkspaceInactiveMembers(workspaceSlug: string): Promise<IWorkspaceMember[]> {
    return this.get(`/api/users/inactive/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async inactiveWorkspaceMember(workspaceSlug: string, memberId: string): Promise<any> {
    return this.delete(`/api/users/me/workspaces/${workspaceSlug}/inactive/${memberId}/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
  ...
  async activeWorkspaceMember(workspaceSlug: string, memberId: string): Promise<any> {
    return this.post(`/api/workspaces/${workspaceSlug}/users/restore/${memberId}/`)
      .then((response) => response?.data)
      .catch((error) => {
        throw error?.response?.data;
      });
